...
Weijie Zheng*, Huawei Mu*, Zhiyi Chen, Jiajun Liu, Debin Xia, Yuxiao, Cheng, Qi Jing, Jin Tang, Guo-Qiang Bi, Feng Wu and Hao Wang. NEATmap: a deep learning approach for high-efficiency whole mouse brain neuralactivity analysis submitted to *Nature Methods*.
